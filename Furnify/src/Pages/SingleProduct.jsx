    ...
    <div className="mt-6 grid gap-y-8 lg:grid-cols-2 lg:gap-x-16">
      ...
      <div>
         ...
         {/* colors  */}
          ...
          {
            colors.map((color)=>
                <button className={`badge h-6 w-6 mr-2 ${color === selectedColor && 'border-2 border-secondary'}`} style={{ backgroundColor: color }} key={color} onClick={()=>setSelectedColor(color)}></button>
            )
          }
          {/* amount */}
